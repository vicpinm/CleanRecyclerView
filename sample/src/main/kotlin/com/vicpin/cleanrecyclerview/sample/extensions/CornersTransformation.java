...
public class CornersTransformation implements Transformation<Bitmap> {
    ...
    public CornersTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public CornersTransformation(BitmapPool pool, int radius, int margin) {
