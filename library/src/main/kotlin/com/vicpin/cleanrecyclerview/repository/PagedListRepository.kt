 ...
 */
class PagedListRepository<DataEntity, CustomData> constructor(internal var cache: CacheDataSource<DataEntity, CustomData>? = null, internal var cloud: CloudPagedDataSource<DataEntity, CustomData>? = null, var customData: CustomData? = null) : IRepository<DataEntity> {
